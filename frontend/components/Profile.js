...
function Profile({ user, setUser, onLogout }) {
  ...
  const localUser = user || (typeof window !== "undefined" ? JSON.parse(localStorage.getItem("user") || "null") : null);
    ...
    <div className="profile-container">
      ...
      <div className="profile-content">
        <div className="profile-card">
          ...
          {success && (
            <div style={{ backgroundColor: "#d1fae5", color: "#065f46", padding: "12px", borderRadius: "8px", marginBottom: "20px" }}>
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <input type="email" className="form-input" value={localUser?.email} disabled style={{ backgroundColor: "#f3f4f6" }} />
            </div>
