...
app.config["SQLALCHEMY_DATABASE_URI"] = os.getenv("DATABASE_URL", "sqlite:///cheapfuel.db")
...
class User(db.Model):
    ...
    car_make = db.Column(db.String(100))  # e.g., Toyota, Honda, Ford
    car_model = db.Column(db.String(100))  # e.g., Corolla, Civic, F-150
